              ...
              <div className="p-[10px]">
                ...
                <div className="grid md:space-x-4 space-y-4 grid-cols-12 py-[10px] border-t border-solid border-accentGray-600">
                  <div className="flex gap-2 sm:gap-8 col-span-12 md:col-span-6">
                    ...
                    <div>
                      <div className="font-semibold text-sm sm:text-base max-w-[390px]">
                        {el.name}
                      </div>
                      <div className="text-accentGray-700 text-xs sm:text-base">
                  ...
                  <div className="col-span-6 md:col-span-3 flex justify-end items-end md:items-start">
                    <button className="text-xs sm:text-base flex-shrink-0 border border-solid bg-accentGray-400 border-accentGray-600 rounded-md h-8 sm:h-10 px-4 sm:px-6 font-bold hover:-translate-y-1 transition-transform ">
                      Message Buyer
                    </button>
                  </div>
                </div>
