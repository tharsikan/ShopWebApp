...
const Forums = () => {
  return (
    <div className="bg-white border border-solid border-accentGray-600 py-10 px-7 text-center rounded-lg">
      <div className="text-xl font-semibold">Old Forums</div>
      <div className="text-xs">Online Curated Threads</div>
      ...
      <div className="font-semibold">Outdated Online Curated Threads</div>
      ...
      <div className="mt-3 font-semibold text-xs">
        ...
        <div className="font-semibold my-2 line-through decoration-orange-700 decoration-2">Seller Fee 8.5%</div>
        <div className="font-semibold my-2">Join Your Communities</div>
        <div className="font-semibold my-2">
          Create and Grow Your Own Communities
        </div>
        <div className="font-semibold my-2 line-through decoration-orange-700 decoration-2">
          Build Virtual Gear Collection
        </div>
        <div className="font-semibold my-2 line-through decoration-orange-700 decoration-2">
          Access Gear Catalog
        </div>
        ...
        <div className="font-semibold my-2 line-through decoration-orange-700 decoration-2">Find Gear Trends</div>
        <div className="font-semibold my-2 line-through decoration-orange-700 decoration-2">
          Access Articles
        </div>
        ...
        <div className="font-semibold my-2 line-through decoration-orange-700 decoration-2">24/7 Support</div>
      </div>
    </div>
  );
}
